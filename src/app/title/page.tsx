...
export default function Home() {
  ...
  const sendtoAI = () => {
    ...
    fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'gpt-3.5-turbo',
        messages: [{ role: 'user', content: `Genera títulos, en formato bullet points, para un vídeo de Youtube sobre: ${inputvalue}` }],
      }),
    })
  ...
  return (
    ...
    <div className="flex justify-center">
      <div className="text-center m-10">
        <h1 className="text-4xl font-bold mb-6">Generate Titles 🚀<p style={{
          color:"#55e6a5"
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-5">
          ...
          <Input
            ...
            placeholder="Type to generate titles 🚀"
