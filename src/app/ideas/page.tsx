...
export default function Home() {
  ...
  const sendtoAI = () => {
    ...
    fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'gpt-3.5-turbo',
        messages: [{ role: 'user', content: `Genera ideas, en formato bullet points, para un vídeo de Youtube sobre: ${inputvalue}` }],
      }),
    })
  ...
  return (
    ...
    <div className="flex justify-center">
      <div className="text-center m-10">
        <h1 className="text-4xl font-bold mb-6">Generate Ideas 💡<p style={{
          color:"#55e6a5"
